 ...
 */
@Data
@Schema(name = "ArtArticleCreateRequest", description = "文章创建请求")
public class ArtArticleCreateRequest implements Serializable {

    @Serial
    private static final long serialVersionUID = 7160338202900073544L;
